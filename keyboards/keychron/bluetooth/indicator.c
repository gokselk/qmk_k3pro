...
#ifdef LED_MATRIX_ENABLE
#    define DECIDE_TIME(t, duration) (duration == 0 ? UINT32_MAX : ((t > duration) ? t : duration))
#endif
#ifdef RGB_MATRIX_ENABLE
#    define DECIDE_TIME(t, duration) (duration == 0 ? UINT32_MAX : ((t > duration) ? t : duration))
#endif
...
#    define LED_DRIVER_ALLOW_SHUTDOWN() (false)
...
#    define LED_DRIVER_DISABLE_TIMEOUT_SET(...)
#    define LED_DRIVER_DISABLE_TIME_RESET()
#endif
